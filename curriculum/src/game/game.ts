...
(function () {
  ...
  function paintBattle() {
    ...
    if (t.scId && t.scId !== sc.id && fx && fx.name === "win" && !reduceMotion) {
      var cur = fx, swapped = false; fx = null;
      var swap = function () { if (swapped) return; swapped = true; t.sprite.removeEventListener("animationend", once); if (bt !== t || !battle) return; t.scId = ""; paintBattle(); };
  ...
  function build() {
    ...
    if (motionQuery) {
      var mq = motionQuery;
      var onMotion = function () { reduceMotion = mq.matches; walkFrame = 0; if (reduceMotion) { settleStep(); } syncAnim(); requestDraw(); };
  ...
  window.CNPE_GAME = {
    mount: function () {
      ...
      scene = "map"; town = null; trial = null; battle = null; dlg = null; bt = null; tn = null; fx = null;
    ...
    unmount: function () {
      ...
      dlg = null; battle = null; trial = null; town = null; bt = null; tn = null; fx = null;
