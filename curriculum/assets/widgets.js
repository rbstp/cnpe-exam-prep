...
(function () {
  ...
  function syncmatrix(mount) {
    ...
    var cells = [
      ...
      { s: "OutOfSync", hh: "Healthy", cls: "warn", t: "Drift, or an un-synced change waiting. If self-heal is on it corrects itself in seconds; if not, <code>argocd app diff</code> shows exactly what diverged. Also what a permanent diff from a mutating webhook looks like, which wants <code>ignoreDifferences</code>." },
