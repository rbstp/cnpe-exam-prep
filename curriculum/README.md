...
- `assets/fonts/`: IBM Plex Sans, Sans Condensed and Mono (latin subsets), shipped so the console needs no network; the sans is one variable file covering wght 100-700, the other five are static weights; SIL OFL 1.1, see `OFL.txt`
